...
PACKAGES=(
    base-devel man-db                                    # build tooling, man pages
...
if [[ "$(findmnt -no FSTYPE /)" == "btrfs" ]]; then
    echo ""
    log "Root is btrfs — after rebooting, run ./scripts/btrfs-optimize.sh to apply compression, scrub, and snapshot tuning (see docs/btrfs-optimize.md)."
fi
